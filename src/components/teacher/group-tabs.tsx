...
export function GroupTabs({ groupId }: Readonly<{ groupId: string }>) {
  ...
  return (
    <div className="flex flex-nowrap gap-1 border-b border-gray-200 mb-6 overflow-x-auto overflow-y-hidden sm:overflow-visible">
      {tabs.map((tab) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={[
              'px-4 py-2 text-sm font-medium rounded-t-md border-b-2 -mb-px transition-colors whitespace-nowrap sm:whitespace-normal sm:text-center sm:min-w-0',
              isActive
