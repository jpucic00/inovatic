export function RobotSvg({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M 46 162 C 28 166 14 180 10 196" stroke="#06b6d4" strokeWidth="20" strokeLinecap="round" fill="none" />
      {/* Left claw */}
      <ellipse cx="10" cy="202" rx="14" ry="11" fill="#0891b2" />
      <path d="M 4 206 C 2 216 0 224 2 230" stroke="#06b6d4" strokeWidth="10" strokeLinecap="round" fill="none" />
      <path d="M 16 206 C 18 216 20 224 18 230" stroke="#06b6d4" strokeWidth="10" strokeLinecap="round" fill="none" />

      {/* Right arm — curved tube */}
      <path d="M 154 162 C 172 166 186 180 190 196" stroke="#06b6d4" strokeWidth="20" strokeLinecap="round" fill="none" />
      {/* Right claw */}
      <ellipse cx="190" cy="202" rx="14" ry="11" fill="#0891b2" />
      <path d="M 184 206 C 182 216 180 224 182 230" stroke="#06b6d4" strokeWidth="10" strokeLinecap="round" fill="none" />
      <path d="M 196 206 C 198 216 200 224 198 230" stroke="#06b6d4" strokeWidth="10" strokeLinecap="round" fill="none" />
