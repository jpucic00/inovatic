export function PartyRobotSvg({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="36" cy="10" r="3" fill="#06b6d4" />
      ...
      <rect x="64" y="12" width="72" height="9" fill="#06b6d4" clipPath="url(#partyHatClip)" />
      <rect x="64" y="25" width="72" height="9" fill="#f87171" clipPath="url(#partyHatClip)" />
      <rect x="64" y="38" width="72" height="8" fill="#06b6d4" clipPath="url(#partyHatClip)" />
      {/* Hat rim */}
      ...
      {/* Neck */}
      <rect x="86" y="128" width="28" height="14" rx="6" fill="#0891b2" />

      {/* Body — compact, rounded */}
      <rect x="36" y="142" width="128" height="80" rx="22" fill="#0891b2" />
      <rect x="44" y="148" width="112" height="20" rx="10" fill="#22d3ee" opacity="0.14" />

      {/* Chest panel */}
      <rect x="50" y="158" width="64" height="46" rx="9" fill="#06b6d4" />
      ...
      <circle cx="146" cy="178" r="13" fill="#0891b2" />
      ...
      <path d="M 46 158 C 24 146 8 128 4 110" stroke="#06b6d4" strokeWidth="20" strokeLinecap="round" fill="none" />
      {/* Left claw (raised, prongs pointing up) */}
      <ellipse cx="4" cy="104" rx="11" ry="14" fill="#0891b2" />
      <path d="M -1 98 C -3 88 -2 82 0 76" stroke="#06b6d4" strokeWidth="9" strokeLinecap="round" fill="none" />
      <path d="M 9 98 C 11 88 12 82 10 76" stroke="#06b6d4" strokeWidth="9" strokeLinecap="round" fill="none" />

      {/* Right arm — raised in celebration */}
      <path d="M 154 158 C 176 146 192 128 196 110" stroke="#06b6d4" strokeWidth="20" strokeLinecap="round" fill="none" />
      {/* Right claw (raised, prongs pointing up) */}
      <ellipse cx="196" cy="104" rx="11" ry="14" fill="#0891b2" />
      <path d="M 191 98 C 189 88 188 82 190 76" stroke="#06b6d4" strokeWidth="9" strokeLinecap="round" fill="none" />
      <path d="M 201 98 C 203 88 204 82 202 76" stroke="#06b6d4" strokeWidth="9" strokeLinecap="round" fill="none" />
      ...
      {/* Left foot */}
      <rect x="46" y="256" width="52" height="16" rx="8" fill="#06b6d4" />
      {/* Right foot */}
      <rect x="102" y="256" width="52" height="16" rx="8" fill="#06b6d4" />
    </svg>
  )
}
