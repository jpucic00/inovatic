...
| `STUDENT` | `/portal` — **only with an ACTIVE enrollment**; exactly ONE enrollment is then forwarded on to `/portal/grupa/<id>` | `/portal/*` (any auth) | `requireAuth`, `requireStudent`, `requireActiveStudent` |
